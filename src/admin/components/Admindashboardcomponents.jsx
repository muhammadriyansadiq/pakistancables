...
const Admindasjboardcomponents = ({ collapsed, toggleCollapsed }) => {
  ...
  const items = [
...

    {
      label: (
        <p
          className={`flex items-center font-bold  ${collapsed
  ...
  return (
    <>
      <div
        className={`admin-dashboard fixed   ${collapsed
          ? " max-h-screen overflow-auto  collapsed"
          : " max-h-screen overflow-auto  expanded"} `
