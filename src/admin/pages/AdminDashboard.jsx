  ...
  return (
    <>
      <div className="relative flex w-full shadow-lg mb-[-26px] ">
        {/* see state changed on small width to set the ui */}
        <div className=" left">
          {/* on toggle btn which has been created on navbar changed the width of admindashboardcomponents you can see on app.css and Admindasjboardcomponents components  */}
          {see ? <Admindasjboardcomponents collapsed={collapsed} /> : ""}
        </div>

        <div
          className={`right transition-all overflow-x-hidden duration-200 ease-in-out  homeright  min-h-screen ml-[-1px] w-[100%]   bg-[#f4f5f8] ${see ? "xs:ml-[60px]" : "ml-[0px]"} ${collapsed ? "md:ml-[60px]" : "md:ml-[250px]"}  ${collapsed ? "lg:ml-[60px]" : "lg:ml-[250px]"}  }  `}
        >
          ...
          <div className=" content w-full">
            ...
            <div className="  flex justify-center mt-8">
              <div className=" w-[97%] flex flex-col justify-between lg:flex-row">
                <div data-aos="flip-left" className="w-full lg:w-[48%] px-4 py-6 bg-white">
